...
if (!class_exists('WC_Freterapido_Main')) :
	...
	function fr_install()
	{
		...
		$fr_categories = [
			...
			[ 'name' => 'Acessório para decoração (com vidro)', 'code' => 109 ],
			[ 'name' => 'Acessório para decoração (sem vidro)', 'code' => 110 ],
			[ 'name' => 'Acessórios automotivos', 'code' => 111 ],
			[ 'name' => 'Acessórios de Airsoft / Paintball', 'code' => 69 ],
			[ 'name' => 'Acessórios de Arquearia', 'code' => 73 ],
			[ 'name' => 'Acessórios de Pesca', 'code' => 70 ],
			[ 'name' => 'Acessórios para bicicleta', 'code' => 112 ],
			...
			[ 'name' => 'Cama / Mesa / Banho', 'code' => 115 ],
			[ 'name' => 'Cargas refrigeradas/congeladas', 'code' => 62 ],
			[ 'name' => 'Chapas de madeira', 'code' => 116 ],
			...
			[ 'name' => 'Materiais hidráulicos / Encanamentos', 'code' => 97 ],
			...
			[ 'name' => 'Porta / Janelas (sem vidro)', 'code' => 95 ],
			[ 'name' => 'Portas / Janelas (com vidro)', 'code' => 118 ],
